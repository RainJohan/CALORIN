...
As the game progresses, curses become more difficult and appear in larger numbers, so players must manage resources well, place units strategically, and survive each wave.
...
- **Left Click with Seal ON selected** → Remove a placed sorcerer (Click again to turn it off so you can't accidentally remove your sorcerers)

### Buttons
- **⏸ Pause** → Pause or resume the game
- **↺ Reset Exorcism** → Restart the game from the beginning
- **🔊 Audio ON / OFF** → Turn the game music, sound effects, and voicelines on or off
...
- **Gojo** — Auto-attacking sorcerer with special knockback shots
